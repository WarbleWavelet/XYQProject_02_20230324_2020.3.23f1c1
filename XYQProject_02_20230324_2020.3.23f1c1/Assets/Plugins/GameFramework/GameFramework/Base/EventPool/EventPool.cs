...
namespace GameFramework
{
    ...
    internal sealed partial class EventPool<T> where T : BaseEventArgs
    {
        ...
        private readonly GameFrameworkMultiDictionary<int, EventHandler<T>> m_EventHandlers;//事件处理者字典
        private readonly Queue<Event> m_Events;                                             //抛出事件队列
        private readonly Dictionary<object, LinkedListNode<EventHandler<T>>> m_CachedNodes;//缓存节点字典
        private readonly Dictionary<object, LinkedListNode<EventHandler<T>>> m_TempNodes;  //临时节点字典

...
namespace UnityGameFramework.Editor.ResourceTools
{
    ...
    internal sealed partial class ResourceEditor : EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            {
                GUILayout.Space(2f);
                EditorGUILayout.BeginVertical(GUILayout.Width(position.width * 0.25f)); //Resource List
                {
                    GUILayout.Space(5f);
                ...
                EditorGUILayout.BeginVertical(GUILayout.Width(position.width * 0.25f));//Resource Content
                {
                    GUILayout.Space(5f);
                ...
                EditorGUILayout.EndVertical();
                EditorGUILayout.BeginVertical(GUILayout.Width(position.width * 0.5f - 16f));//Asset List
                {
                    GUILayout.Space(5f);

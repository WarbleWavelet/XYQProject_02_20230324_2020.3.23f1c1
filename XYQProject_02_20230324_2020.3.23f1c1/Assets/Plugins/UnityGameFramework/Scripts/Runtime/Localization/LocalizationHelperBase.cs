...
namespace UnityGameFramework.Runtime
{
    ...
    public abstract class LocalizationHelperBasePre : MonoBehaviour,  ILocalizationHelper
    {
        /// <summary>
        /// 获取系统语言。
        /// </summary>
        ...
        /// <param name="userData">用户自定义数据。</param>
        /// <returns>是否读取字典成功。</returns>
        public abstract bool ReadData(string dictionaryAssetName, object dictionaryAsset, object userData);
        ...
        /// <param name="userData">用户自定义数据。</param>
        /// <returns>是否解析字典成功。</returns>
        public abstract bool ParseData(string dictionaryString, object userData);
        ...
        /// <param name="localizationManager">本地化管理器。</param>
        /// <param name="dictionaryAsset">要释放的字典资源。</param>
        public abstract void ReleaseDataAsset( object dictionaryAsset);
    }
